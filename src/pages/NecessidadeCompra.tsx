  ...
  return (
    <div className="flex flex-col gap-4 w-full flex-1 min-h-0 overflow-hidden px-4 md:px-6 py-3 animate-fade-in-up">
      ...
      <Tabs defaultValue="produto" className="flex flex-col flex-1 min-h-0 gap-4">
        ...
        <TabsContent value="produto" className="flex flex-col flex-1 min-h-0 gap-4 mt-0">
                              ...
                              <TableCell className="align-middle py-2">
                                <span className="text-sm text-slate-600">
                                  {r.proxima_data_prevista_entrega
                                    ? new Date(r.proxima_data_prevista_entrega).toLocaleDateString(
                                        'pt-BR',
                                      )
                                    : '-'}
                                </span>
        ...
        <TabsContent value="item" className="flex flex-col flex-1 min-h-0 mt-0">
